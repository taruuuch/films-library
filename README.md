...
- [x] Добавить фильм <span style="color:green">✓</span>
- [x] Удалить фильм <span style="color:green">✓</span>
- [x] Показать информацию о фильме <span style="color:green">✓</span>
...
- [x] Найти фильм по имени актера. <span style="color:green">✓</span>
